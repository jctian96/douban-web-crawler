...
movie_tags = '爱尔兰,科幻,电影' # The types of art works.


def change_request_headers(new_request_headers):
...
def main():
    # Initialize the database and data set that store the obtained information.
    client = MongoClient('localhost',27017)
    database = client['douban']
    movies_data = database['douban_movies_data000']
